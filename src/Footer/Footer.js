    ...
    <>
      <footer>
        <div className="wrapper">
          <div className="footer-container">
            ...
            <div>
              <div className="col-container">
                <div className="container__colItems">
                  <ul className="container__colItems__list">
                    <li className="container__colItems__list__boldElem">
                      Shop and Learn
                    </li>
                    <li>
                      <a href="">Store</a>
          ...
          <div>
            <div className="footer-element footer-middle-element">
              More ways to shop:
          ...
          <div>
            <div className="container__colItems">
              <div className="container-items-rows">
                <div className="copyright-language">
                  <div>Copyright © 2022 Apple Inc. All rights reserved.</div>

                  <div className="container-mobile-order">
                    <div className="container-items-rows single-item-row">
